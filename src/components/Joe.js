      ...
      >
        <div className="joe">
          <Typography variant="body1">
            ...
            11th, 1921, in Beach, North Dakota. He had two younger brothers,
            Robert (Bob) and Walter, and they grew up at 410 West Lee Street, on
          ...
          <Typography variant="body1">
            ...
            utilized this privilege by delivering food for a local grocer. That
            was his first real job, and he made the best of every minute of his
            employment. Occasionally, he even used this opportunity to visit his
            girlfriend, Donna Davis.
          </Typography>
          <br />
          <Typography variant="body1">
            Joe Noyes is fondly remembered for being hard-working, dedicated to
            his commitments, and possessing a keen sense of humor.
          </Typography>
        </div>
      </Box>
      <div class="resources">
